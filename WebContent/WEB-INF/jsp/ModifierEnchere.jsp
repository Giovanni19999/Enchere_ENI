...
<body>
	...
	<form action="" method="post">
		...
		<a href="${pageContext.request.contextPath}/retour/encheres"><input type="submit" name="annuler" value="Annuler modifications"></a>
		<a href="${pageContext.request.contextPath}/retour/encheres"><input type="submit" name="supprimer" value="Supprimer l'enhère"></a>
	</form>
